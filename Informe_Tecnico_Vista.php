...
<?php 
							echo "
								...
								<li ><a href=\"presupuestos.php?id=".$_SESSION["id"]."\"><i class=\"icon-pencil\"></i> Presupuesto</a></li>
								<li class=\"active\"><a href=\"Lista_Informes_Tecnicos.php?id=".$_SESSION["id"]."\"><i class=\"icon-pencil\"></i> Informe Tecnico</a></li>
                    ...
                    <?php $consulta="SELECT * FROM inf_tec WHERE id='".$_GET["id"]."'";
                    ...
                    <hr></hr>
  						<form class="form-horizontal" method="post" action="Funciones.php">
								...
								<div class="span5">
  									<label>Fecha:</label>
  									<input type="date" readonly class="input-small" name="fecha" value="<?php echo $fila[fecha]?>">
                                </div>
                                <div class="span5">
  									<label>Estado</label>
                                ...
                                <div class="span10">
  									<label align="center">Memoria Descriptiva:</label>
  									<textarea rows="5" class="input-block-level" type="text" name="inputExpo"><?php echo $fila[descripcion]?></textarea>
								</div>
                          ...
                          <div class="span14 well" style="background:#FFFFFF">
							<table class="table table-striped" id="tabla">
  								...
  								<tbody>
  								<?php
									$consulta="SELECT * FROM item_inf WHERE inf_tec_id = '".$_GET["id"]."'";
									$res=consultar($consulta);
